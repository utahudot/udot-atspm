...
namespace DatabaseInstaller.Commands
{
    public class UpdateCommand : Command, ICommandOption<UpdateCommandConfiguration>
    {
        ...
        {
            AddArgument(ConfigConnectionArgument);
            AddArgument(AggregationConnectionArgument);
            AddArgument(EventLogConnectionArgument);
            AddArgument(IdentityConnectionArgument);
        ...
        public Argument<string> ConfigConnectionArgument { get; set; } = new("config-connection", "Connection string for ConfigContext");
        public Argument<string> AggregationConnectionArgument { get; set; } = new("aggregation-connection", "Connection string for AggregationContext");
        public Argument<string> EventLogConnectionArgument { get; set; } = new("eventlog-connection", "Connection string for EventLogContext");
        public Argument<string> IdentityConnectionArgument { get; set; } = new("identity-connection", "Connection string for IdentityContext");
        ...
        public ModelBinder<UpdateCommandConfiguration> GetOptionsBinder()
        {
            ...
            binder.BindMemberFromValue(b => b.ConfigConnection, ConfigConnectionArgument);
            binder.BindMemberFromValue(b => b.AggregationConnection, AggregationConnectionArgument);
            binder.BindMemberFromValue(b => b.EventLogConnection, EventLogConnectionArgument);
            binder.BindMemberFromValue(b => b.IdentityConnection, IdentityConnectionArgument);
