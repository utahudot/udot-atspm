...
// for ApplicationTests - Utah.Udot.Atspm.ApplicationTests.Analysis.WorkflowFilterTests/FilteredPedPhaseDataTests.cs
// 
...
{
    public class FilteredPedPhaseDataTests : WorkflowFilterTestsBase
    {
        public FilteredPedPhaseDataTests(ITestOutputHelper output) : base(output)
        {
