...
// for Infrastructure - Utah.Udot.Atspm.Infrastructure.Repositories.AggregationRepositories/PhaseCycleAggregationEFRepository.cs
// 
...
namespace Utah.Udot.Atspm.Infrastructure.Repositories.AggregationRepositories
{
    ...
    {
        ///<inheritdoc/>
        public PhaseCycleAggregationEFRepository(AggregationContext db, ILogger<PhaseCycleAggregationEFRepository> log) : base(db, log) { }
