...
// for Infrastructure - Utah.Udot.Atspm.Infrastructure.Repositories.AggregationRepositories/SignalEventCountAggregationEFRepository.cs
// 
...
namespace Utah.Udot.Atspm.Infrastructure.Repositories.AggregationRepositories
{
    ...
    {
        ///<inheritdoc/>
        public SignalEventCountAggregationEFRepository(AggregationContext db, ILogger<SignalEventCountAggregationEFRepository> log) : base(db, log) { }
