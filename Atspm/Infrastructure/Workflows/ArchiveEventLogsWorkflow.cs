...
// for Infrastructure - Utah.Udot.ATSPM.Infrastructure.Workflows/ArchiveEventLogsWorkflow.cs
// 
...
{
    /// <summary>
    /// A workflow designed to batch, compress, and persist device event logs into an archive repository.
    /// </summary>
    public class ArchiveEventLogsWorkflow : WorkflowBase<Tuple<Device, EventLogModelBase>, CompressedEventLogBase>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchiveEventLogsWorkflow"/> class.
        /// </summary>
        /// <param name="services">The service scope factory for repository dependencies.</param>
        /// <param name="batchSize">The number of logs to group before processing.</param>
        /// <param name="parallelProcesses">The maximum degree of parallelism for the archival step.</param>
        /// <param name="cancellationToken">The token to monitor for workflow cancellation.</param>
