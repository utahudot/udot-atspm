...
// for OracleDatabaseProvider - Utah.Udot.ATSPM.OracleDatabaseProvider.Migrations/20260727183000_AddTimeOfDayMeasureDefaults.cs
//
    ...
    public partial class AddTimeOfDayMeasureDefaults : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "NUMBER(10)", "VARCHAR2(8)", "NUMBER(10)", "TIMESTAMP(7) WITH TIME ZONE", "VARCHAR2(4000)", "VARCHAR2(50)", "BOOLEAN", "BOOLEAN" },
            ...
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "NUMBER(10)", "NUMBER(10)", "TIMESTAMP(7) WITH TIME ZONE", "VARCHAR2(4000)", "VARCHAR2(128)", "VARCHAR2(512)" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "NUMBER(10)", "NUMBER(10)", "TIMESTAMP(7) WITH TIME ZONE", "VARCHAR2(4000)", "VARCHAR2(512)", "NVARCHAR2(2000)" },
                values: new object[,]
                {
