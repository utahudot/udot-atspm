...
// for OracleDatabaseProvider - Utah.Udot.ATSPM.OracleDatabaseProvider.Migrations/20250227162643_5_0.cs
// 
    ...
    public partial class _5_0 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Description = table.Column<string>(type: "VARCHAR2(128)", unicode: false, maxLength: 128, nullable: false),
                    Abbreviation = table.Column<string>(type: "VARCHAR2(5)", unicode: false, maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Description = table.Column<string>(type: "VARCHAR2(30)", unicode: false, maxLength: 30, nullable: true),
                    Abbreviation = table.Column<string>(type: "VARCHAR2(5)", unicode: false, maxLength: 5, nullable: true),
                    DisplayOrder = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Header = table.Column<string>(type: "VARCHAR2(256)", unicode: false, maxLength: 256, nullable: false),
                    Body = table.Column<string>(type: "CLOB", unicode: false, maxLength: 8000, nullable: false),
                    DisplayOrder = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Name = table.Column<string>(type: "VARCHAR2(50)", unicode: false, maxLength: 50, nullable: false),
                    Mpo = table.Column<string>(type: "VARCHAR2(50)", unicode: false, maxLength: 50, nullable: true),
                    CountyParish = table.Column<string>(type: "VARCHAR2(50)", unicode: false, maxLength: 50, nullable: true),
                    OtherPartners = table.Column<string>(type: "VARCHAR2(50)", unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "VARCHAR2(255)", unicode: false, maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abbreviation = table.Column<string>(type: "VARCHAR2(8)", unicode: false, maxLength: 8, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Name = table.Column<string>(type: "VARCHAR2(128)", unicode: false, maxLength: 128, nullable: false),
                    Icon = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    DisplayOrder = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Link = table.Column<string>(type: "VARCHAR2(4000)", unicode: false, maxLength: 4000, nullable: true),
                    Document = table.Column<byte[]>(type: "RAW(2000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Manufacturer = table.Column<string>(type: "VARCHAR2(48)", unicode: false, maxLength: 48, nullable: false),
                    Model = table.Column<string>(type: "VARCHAR2(48)", unicode: false, maxLength: 48, nullable: false),
                    WebPage = table.Column<string>(type: "VARCHAR2(4000)", unicode: false, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationIdentifierA = table.Column<string>(type: "VARCHAR2(10)", unicode: false, maxLength: 10, nullable: false),
                    LocationIdentifierB = table.Column<string>(type: "VARCHAR2(10)", unicode: false, maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
                    Date = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2025, 2, 27, 9, 26, 38, 588, DateTimeKind.Local).AddTicks(4189)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    LocationId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    LocationIdentifier = table.Column<string>(type: "VARCHAR2(4000)", unicode: false, nullable: false),
                    Timestamp = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    ComponentType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    ComponentId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    IssueType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Details = table.Column<string>(type: "VARCHAR2(4000)", unicode: false, nullable: false),
                    Phase = table.Column<int>(type: "NUMBER(10)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "VARCHAR2(900)", unicode: false, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "VARCHAR2(900)", unicode: false, nullable: false),
                    JurisdictionId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DetectionTypesId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    MeasureTypesId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MeasureCommentsId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    MeasureTypesId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Option = table.Column<string>(type: "VARCHAR2(128)", unicode: false, maxLength: 128, nullable: true),
                    Value = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Description = table.Column<string>(type: "VARCHAR2(24)", unicode: false, maxLength: 24, nullable: false),
                    Notes = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
                    Protocol = table.Column<string>(type: "NVARCHAR2(7)", maxLength: 7, nullable: false, defaultValue: "Unknown"),
                    Port = table.Column<int>(type: "NUMBER(10)", nullable: false, defaultValueSql: "((0))"),
                    ConnectionProperties = table.Column<string>(type: "NVARCHAR2(1024)", maxLength: 1024, nullable: true),
                    Path = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
                    Query = table.Column<string>(type: "NVARCHAR2(512)", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
                    ConnectionTimeout = table.Column<int>(type: "NUMBER(10)", nullable: false, defaultValueSql: "((2000))"),
                    OperationTimeout = table.Column<int>(type: "NUMBER(10)", nullable: false, defaultValueSql: "((2000))"),
                    LoggingOffset = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Decoders = table.Column<string>(type: "NVARCHAR2(512)", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
                    UserName = table.Column<string>(type: "VARCHAR2(50)", unicode: false, maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryName = table.Column<string>(type: "VARCHAR2(100)", unicode: false, maxLength: 100, nullable: false, defaultValueSql: "('')"),
                    SecondaryName = table.Column<string>(type: "VARCHAR2(100)", unicode: false, maxLength: 100, nullable: true),
                    ChartEnabled = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    VersionAction = table.Column<int>(type: "NUMBER(10)", nullable: false, defaultValueSql: "((10))"),
                    Note = table.Column<string>(type: "VARCHAR2(256)", unicode: false, maxLength: 256, nullable: false, defaultValueSql: "('Initial')"),
                    Start = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    PedsAre1to1 = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    LocationIdentifier = table.Column<string>(type: "VARCHAR2(10)", unicode: false, maxLength: 10, nullable: false),
                    JurisdictionId = table.Column<int>(type: "NUMBER(10)", nullable: true, defaultValueSql: "((0))"),
                    LocationTypeId = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryPhase = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    OpposingPhase = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    PrimaryDirectionId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    OpposingDirectionId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    ...
                    PreviousLocationDistanceId = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    NextLocationDistanceId = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    LocationIdentifier = table.Column<string>(type: "VARCHAR2(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Description = table.Column<string>(type: "VARCHAR2(4000)", unicode: false, nullable: true),
                    Mph = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    ProtectedPhaseNumber = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    IsProtectedPhaseOverlap = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    PermissivePhaseNumber = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    IsPermissivePhaseOverlap = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    PedestrianPhaseNumber = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    IsPedestrianPhaseOverlap = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    PedestrianDetectors = table.Column<string>(type: "VARCHAR2(4000)", unicode: false, nullable: true),
                    LocationId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DirectionTypeId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AreasId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    LocationsId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    DeviceIdentifier = table.Column<string>(type: "VARCHAR2(50)", unicode: false, maxLength: 50, nullable: false),
                    DeviceProperties = table.Column<string>(type: "NVARCHAR2(1024)", maxLength: 1024, nullable: true),
                    LoggingEnabled = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    Ipaddress = table.Column<string>(type: "VARCHAR2(15)", unicode: false, maxLength: 15, nullable: false, defaultValueSql: "('0.0.0.0')"),
                    DeviceStatus = table.Column<string>(type: "NVARCHAR2(14)", maxLength: 14, nullable: false, defaultValue: "Unknown"),
                    DeviceType = table.Column<string>(type: "NVARCHAR2(16)", maxLength: 16, nullable: false, defaultValue: "Unknown"),
                    Notes = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
                    LocationId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DeviceConfigurationId = table.Column<int>(type: "NUMBER(10)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComponentType = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    ComponentId = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    IssueType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Phase = table.Column<int>(type: "NUMBER(10)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    DectectorIdentifier = table.Column<string>(type: "VARCHAR2(50)", unicode: false, maxLength: 50, nullable: false),
                    DetectorChannel = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DistanceFromStopBar = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    MinSpeedFilter = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    DateAdded = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    DateDisabled = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    LaneNumber = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    MovementType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    LaneType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DetectionHardware = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DecisionPoint = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    MovementDelay = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    LatencyCorrection = table.Column<double>(type: "BINARY_DOUBLE", nullable: false),
                    ApproachId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    DetectionTypesId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DetectorsId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    TimeStamp = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    Comment = table.Column<string>(type: "VARCHAR2(256)", unicode: false, maxLength: 256, nullable: false),
                    DetectorId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
