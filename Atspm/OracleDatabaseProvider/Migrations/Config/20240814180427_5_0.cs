...
// for OracleDatabaseProvider - Utah.Udot.ATSPM.OracleDatabaseProvider.Migrations/20240814180427_5_0.cs
// 
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowOnWebsite = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    ShowOnAggregationSite = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    DisplayOrder = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
                    Date = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false, defaultValue: new DateTime(2024, 8, 14, 12, 4, 24, 660, DateTimeKind.Local).AddTicks(7522)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Firmware = table.Column<string>(type: "VARCHAR2(16)", unicode: false, maxLength: 16, nullable: false),
                    Notes = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
                    ...
                    Directory = table.Column<string>(type: "VARCHAR2(512)", unicode: false, maxLength: 512, nullable: true),
                    SearchTerms = table.Column<string>(type: "NVARCHAR2(512)", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChartEnabled = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    ...
                    PedsAre1to1 = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    LocationIdentifier = table.Column<string>(type: "VARCHAR2(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrimaryOverlap = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    IsOpposingOverlap = table.Column<bool>(type: "NUMBER(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsProtectedPhaseOverlap = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    PermissivePhaseNumber = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    IsPermissivePhaseOverlap = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    PedestrianPhaseNumber = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    IsPedestrianPhaseOverlap = table.Column<bool>(type: "NUMBER(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    LoggingEnabled = table.Column<bool>(type: "NUMBER(1)", nullable: false),
