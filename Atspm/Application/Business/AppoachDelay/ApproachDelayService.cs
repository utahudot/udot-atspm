...
// for Application - Utah.Udot.Atspm.Business.AppoachDelay/ApproachDelayService.cs
// 
    ...
    public class ApproachDelayService
    {
            ...
            LocationPhase LocationPhase)
        {
            ...
            while (dt < LocationPhase.EndDate)
            {
                ...
                var binDelay = detectorEvents.Where(d => d.ArrivalType == Common.ArrivalType.ArrivalOnRed).Sum(d => d.DelaySeconds);
