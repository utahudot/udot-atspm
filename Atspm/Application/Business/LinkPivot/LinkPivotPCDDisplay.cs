...
// for ApplicationCore - %Namespace%/LinkPivotPCDDisplay.cs
// 
...
//{
//    public class LinkPivotPCDDisplayDTO
//    {
...
//        public double ExistingTotalPAOG { get; set; }
//        public double PredictedTotalAOG { get; set; }
//        public double PredictedTotalPAOG { get; set; }
...
//        public LinkPivotPCDDisplayDTO GetLinkPivotPCDDisplay(string upstreamSignalId, string upstreamDirection,
...
//            var approaches = signal.Approaches.Where(a => a.DirectionType.Id == direction).ToList();
...
//            if (!string.IsNullOrEmpty(approach.DirectionType.Id))
//            {
...
//                    6, approach.DirectionTypeId).FirstOrDefault();
//                //Check for null value
//                if (detector != null)
//                {

//                    //Instantiate a signal phase object
//                    var sp = locationPhaseService.GetLocationPhaseData(new LocationPhase(startDate, endDate, approach, false, 15, 13, false);
...
//                signalPhase.Approach.DirectionType.Id, location, signalPhase.Approach.IsProtectedPhaseOverlap,
