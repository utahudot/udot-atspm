...
namespace Utah.Udot.Atspm.Analysis.WorkflowSteps
{
    public class BreakOutIndianaEvent : TransformProcessStepBase<Tuple<Location, IEnumerable<IndianaEvent>, IEnumerable<SpeedEvent>>, Tuple<Location, IEnumerable<IndianaEvent>>>
    {
        ...
        protected override Task<Tuple<Location, IEnumerable<IndianaEvent>>> Process(Tuple<Location, IEnumerable<IndianaEvent>, IEnumerable<SpeedEvent>> input, CancellationToken cancelToken = default)
        {
