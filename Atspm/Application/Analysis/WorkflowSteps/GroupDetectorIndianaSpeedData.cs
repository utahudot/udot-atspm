...
{
    public class GroupDetectorIndianaSpeedData : TransformManyProcessStepBase<Tuple<Location, IEnumerable<IndianaEvent>>, Tuple<Detector, string, IEnumerable<IndianaEvent>>>
    {
