...
// for IdentityApi - Utah.Udot.ATSPM.IdentityApi.Controllers.v1/ApiKeyController.cs
// 
...
namespace Utah.Udot.ATSPM.IdentityApi.Controllers.v1
{
    ...
    public class ApiKeyController : IdentityControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] CreateApiKeyDto dto)
        {
            ...
            var ownerId = dto.UserId.HasValue ? dto.UserId.Value.ToString() : _userManager.GetUserId(User);
