...
// for SqlDatabaseProvider - Utah.Udot.ATSPM.SqlDatabaseProvider.Migrations/20260727183000_AddTimeOfDayMeasureDefaults.cs
//
    ...
    public partial class AddTimeOfDayMeasureDefaults : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "int", "varchar(8)", "int", "datetimeoffset", "varchar(max)", "varchar(50)", "bit", "bit" },
            ...
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "int", "int", "datetimeoffset", "varchar(max)", "varchar(512)", "nvarchar(max)" },
                values: new object[,]
                {
