...
// for SqlDatabaseProvider - Utah.Udot.ATSPM.SqlDatabaseProvider.Migrations/20250227162910_5_0.cs
// 
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "varchar(512)", unicode: false, maxLength: 512, nullable: true),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 2, 27, 9, 29, 9, 10, DateTimeKind.Local).AddTicks(3603)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "varchar(24)", unicode: false, maxLength: 24, nullable: false),
                    Notes = table.Column<string>(type: "varchar(512)", unicode: false, maxLength: 512, nullable: true),
                    Protocol = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false, defaultValue: "Unknown"),
                    Port = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((0))"),
                    ConnectionProperties = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    Path = table.Column<string>(type: "varchar(512)", unicode: false, maxLength: 512, nullable: true),
                    Query = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
                    ConnectionTimeout = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((2000))"),
                    OperationTimeout = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((2000))"),
                    LoggingOffset = table.Column<int>(type: "int", nullable: false),
                    Decoders = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeviceIdentifier = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    DeviceProperties = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
