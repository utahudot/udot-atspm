...
// for WebUI - dataQuality.transformer.ts
//
...
// #endregion
import { DataQualitySource } from '@/api/speedManagement/aTSPMSpeedManagementApi.schemas'
import {
  createDataZoom,
  createGrid,
  createLegend,
