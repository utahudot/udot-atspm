 ...
 */
export function generatePin(locationTypeId: number): L.DivIcon {
...
/**
 * Constructs a DivIcon using the pin SVG, plus a white circle "badge"
 * with a given MUI icon on top.
 */
export function createPinWithIcon({
  color,
  MuiIcon,
  iconSize = 17,
  offset = -1,
  ...
  return L.divIcon({
    html: ReactDOMServer.renderToString(
      <div style={{ position: 'relative', width: '25px', height: '60px' }}>
        ...
        {/* White circle “badge” + MUI icon on top */}
        <div
          style={{
            position: 'absolute',
            top: '13px',
