...
// for SqlLiteDatabaseProvider - Utah.Udot.ATSPM.SqlLiteDatabaseProvider.Migrations/20260727183000_AddTimeOfDayMeasureDefaults.cs
//
    ...
    public partial class AddTimeOfDayMeasureDefaults : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "INTEGER", "TEXT", "INTEGER", "TEXT", "TEXT", "TEXT", "INTEGER", "INTEGER" },
            ...
            migrationBuilder.InsertData(
                ...
                columnTypes: new[] { "INTEGER", "INTEGER", "TEXT", "TEXT", "TEXT", "TEXT" },
                values: new object[,]
                {
