...
// for SqlLiteDatabaseProvider - Utah.Udot.ATSPM.SqlLiteDatabaseProvider.Migrations/20240814181953_5_0.cs
// 
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
                    Date = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValue: new DateTime(2024, 8, 14, 12, 19, 52, 84, DateTimeKind.Local).AddTicks(1659)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Firmware = table.Column<string>(type: "TEXT", unicode: false, maxLength: 16, nullable: false),
                    Notes = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
                    ...
                    Directory = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
                    SearchTerms = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
