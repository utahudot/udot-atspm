...
// for SqlLiteDatabaseProvider - Utah.Udot.ATSPM.SqlLiteDatabaseProvider.Migrations/20250227163048_5_0.cs
// 
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abbreviation = table.Column<string>(type: "TEXT", unicode: false, maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false),
                    Description = table.Column<string>(type: "TEXT", unicode: false, maxLength: 30, nullable: true),
                    Abbreviation = table.Column<string>(type: "TEXT", unicode: false, maxLength: 5, nullable: true),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Header = table.Column<string>(type: "TEXT", unicode: false, maxLength: 256, nullable: false),
                    Body = table.Column<string>(type: "TEXT", unicode: false, maxLength: 8000, nullable: false),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    Mpo = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    CountyParish = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    OtherPartners = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abbreviation = table.Column<string>(type: "TEXT", unicode: false, maxLength: 8, nullable: true),
                    ShowOnWebsite = table.Column<bool>(type: "INTEGER", nullable: false),
                    ShowOnAggregationSite = table.Column<bool>(type: "INTEGER", nullable: false),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Icon = table.Column<string>(type: "TEXT", nullable: true),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    Link = table.Column<string>(type: "TEXT", unicode: false, maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Manufacturer = table.Column<string>(type: "TEXT", unicode: false, maxLength: 48, nullable: false),
                    Model = table.Column<string>(type: "TEXT", unicode: false, maxLength: 48, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationIdentifierA = table.Column<string>(type: "TEXT", unicode: false, maxLength: 10, nullable: false),
                    LocationIdentifierB = table.Column<string>(type: "TEXT", unicode: false, maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
                    Date = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValue: new DateTime(2025, 2, 27, 9, 30, 47, 162, DateTimeKind.Local).AddTicks(348)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Option = table.Column<string>(type: "TEXT", unicode: false, maxLength: 128, nullable: true),
                    Value = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Description = table.Column<string>(type: "TEXT", unicode: false, maxLength: 24, nullable: false),
                    Notes = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
                    Protocol = table.Column<string>(type: "TEXT", maxLength: 7, nullable: false, defaultValue: "Unknown"),
                    Port = table.Column<int>(type: "INTEGER", nullable: false, defaultValueSql: "((0))"),
                    ConnectionProperties = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    Path = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
                    Query = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
                    ...
                    LoggingOffset = table.Column<int>(type: "INTEGER", nullable: false),
                    Decoders = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true, defaultValueSql: "('[]')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryName = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: false, defaultValueSql: "('')"),
                    SecondaryName = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: true),
                    ChartEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    VersionAction = table.Column<int>(type: "INTEGER", nullable: false, defaultValueSql: "((10))"),
                    Note = table.Column<string>(type: "TEXT", unicode: false, maxLength: 256, nullable: false, defaultValueSql: "('Initial')"),
                    Start = table.Column<DateTime>(type: "TEXT", nullable: false),
                    PedsAre1to1 = table.Column<bool>(type: "INTEGER", nullable: false),
                    LocationIdentifier = table.Column<string>(type: "TEXT", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrimaryOverlap = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsOpposingOverlap = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsProtectedPhaseOverlap = table.Column<bool>(type: "INTEGER", nullable: false),
                    PermissivePhaseNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    IsPermissivePhaseOverlap = table.Column<bool>(type: "INTEGER", nullable: false),
                    PedestrianPhaseNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    IsPedestrianPhaseOverlap = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DeviceIdentifier = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    DeviceProperties = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    LoggingEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    Ipaddress = table.Column<string>(type: "TEXT", unicode: false, maxLength: 15, nullable: false, defaultValueSql: "('0.0.0.0')"),
                    DeviceStatus = table.Column<string>(type: "TEXT", maxLength: 14, nullable: false, defaultValue: "Unknown"),
                    DeviceType = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false, defaultValue: "Unknown"),
                    Notes = table.Column<string>(type: "TEXT", unicode: false, maxLength: 512, nullable: true),
                    LocationId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DectectorIdentifier = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    ...
                    DateDisabled = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    LatencyCorrection = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TimeStamp = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Comment = table.Column<string>(type: "TEXT", unicode: false, maxLength: 256, nullable: false),
