...
public class EffectivenessOfStrategiesDto
{
    ...
    public double ChangeInVariability { get; set; } //Overall Change in Variability = After’s Total Speed Variability – Before’s Total Speed Variability
...
public class TimeSegmentEffectiveness
{
    ...
    public double Variability { get; set; } //Maximum of the MaxSpeed column minus minimum of the MinSpeed column
