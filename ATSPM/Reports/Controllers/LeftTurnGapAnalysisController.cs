...
namespace ATSPM.Application.Reports.Controllers
{
    ...
    public class LeftTurnGapAnalysisController : ControllerBase
    {
        ...
        public List<LeftTurnGapAnalysisResult> GetChartData([FromBody] LeftTurnGapAnalysisOptions options)
        {
            ...
            var viewModel = leftTurnGapAnalysisService.GetChartData(options, approach.Signal, eventLogs.ToList());
            return viewModel;
        }
