...
namespace Legacy.Common.Business.ModelObjectHelpers
{
    public class ConfigurationRecord
    {
        ...
        public ConfigurationRecord(Legacy.Common.Models.Graph_Detectors gd)
        {
            ...
            Legacy.Common.Models.Repositories.IDetectorCommentRepository dcr = Legacy.Common.Models.Repositories.DetectorCommentRepositoryFactory.Create();
