...
namespace Legacy.Common.Business.ModelObjectHelpers
{
    ...
    public class LaneGroupModelHelper
    {
        ...
        public string GetLaneGroupDirection()
        {
            ...
            Legacy.Common.Models.Repositories.IApproachRepository Approaches = Legacy.Common.Models.Repositories.ApproachRepositoryFactory.Create();
            Legacy.Common.Models.Approach approach = Approaches.GetApproachByApproachID(LaneGroup.ApproachID);
