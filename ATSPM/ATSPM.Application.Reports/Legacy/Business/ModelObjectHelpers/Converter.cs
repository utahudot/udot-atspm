...
namespace Legacy.Common.Business.ModelObjectHelpers
{
    public class Converter
    {
        ...
        public List<Legacy.Common.Models.Graph_Detectors> DetectorsList { get; set; }
                    ...
                    for (int movementID = 1; movementID < 6; movementID++)
                    {
                        ...
                        for (int lanenumber = 1; lanenumber < 5; lanenumber++)
                        {
                            ...
                            if (detConvertersByLaneNumber != null)
                            {
                                ...
                                {
                                    LaneGroupByTypeAndMovement.Detectors = new List<Legacy.Common.Models.Graph_Detectors>();
                                }
        ...
        public void ConvertApproachDetailDirections()
        {
            ...
            foreach(var row in RouteDetailTable)
            {
                ...
                Legacy.Common.Models.ApproachRouteDetail newRouteDetail = (from r in db.ApproachRouteDetails 
                                                                       where r.ApproachRouteId == row.ApproachRouteId 
                                                                       select r).FirstOrDefault();
                if (newRouteDetail == null)
                {
                    newRouteDetail = new Legacy.Common.Models.ApproachRouteDetail();
    ...
    public class DetectorConverter
    {
        ...
        public Legacy.Common.Models.Graph_Detectors GraphDetectorModel { get; set; }
