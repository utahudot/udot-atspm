...
namespace Legacy.Common.Business.ModelObjectHelpers
{
    public class SignalModelHelper
    {
        ...
        {
            Legacy.Common.Models.Repositories.ISignalsRepository signals = Legacy.Common.Models.Repositories.SignalsRepositoryFactory.Create();
        ...
        public SignalModelHelper(Legacy.Common.Models.Signal signal)
        {
            Signal = signal;
            Approaches = GetApproachesForSignal();
            LaneGroups = GetLaneGroupsForSignal();
        ...
        {
            Legacy.Common.Models.Repositories.IGraphDetectorRepository gdr = Legacy.Common.Models.Repositories.GraphDetectorRepositoryFactory.Create();
        ...
        {
            Legacy.Common.Business.ModelObjectHelpers.SignalModelHelper smh = new Business.ModelObjectHelpers.SignalModelHelper(SignalID);
        ...
        {
            Legacy.Common.Models.Repositories.IMetricTypeRepository repository =
                Legacy.Common.Models.Repositories.MetricTypeRepositoryFactory.Create();
