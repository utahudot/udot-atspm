...
using Legacy.Common.Business.SiteSecurity;
...
namespace Legacy.Common.Business
{
    ...
    {
        public Legacy.Common.Data.Signals.SignalsDataTable SignalsTable { get; set; }
        public Legacy.Common.Data.Signals.Graph_DetectorsDataTable DetectorsTable { get; set; }
        public Legacy.Common.Data.Signals.SPM_CommentDataTable CommentsTable { get; set; }
        public Legacy.Common.Data.Signals.ApproachRouteDetailDataTable RouteDetailTable { get; set; }
        public Legacy.Common.Data.Signals.ApproachRouteDataTable RouteTable { get; set; }
        public Legacy.Common.Data.Action.ActionLog_DisabledDataTable ActionLogTable { get; set; }
        public Legacy.Common.Data.Action.Metric_ListDataTable MetricList { get; set; }
        public Legacy.Common.Data.Action.Action_Log_MetricsDataTable ActionLogMetrics { get; set; }
        public Legacy.Common.Data.Action.AgenciesDataTable ActionAgencies { get; set; }
        public Legacy.Common.Data.Action.ActionsListDataTable ActionsList { get; set; }
        public Legacy.Common.Data.Action.Action_Log_ActionsDataTable ActionLogActions { get; set; }
        public Legacy.Common.Data.Settings.MOE_UsersDataTable OldUsersTable { get; set; }

        public List<Legacy.Common.Models.Signal> SignalsList { get; set; }
        public List<Legacy.Common.Models.Detector> DetectorsList { get; set; }
        ...
        public void UpdateToNewDatabaseModel()
        {
            ...
            var config = new Legacy.Common.Migrations.Configuration();
        ...
        private void SetNonLaneDetectors()
        {
            ...
            foreach (Legacy.Common.Data.Signals.Graph_DetectorsRow row in DetectorsTable)
            {
        ...
        private Models.Detector CreateNewDetector(Data.Signals.Graph_DetectorsRow row, List<Models.DetectionType> detectionstypeslist)
        {
            ...
            if (detector.DetectionTypes == null && detector.DetectionTypeIDs == null)
            {
                ...
                detector.DetectionTypes = new List<Legacy.Common.Models.DetectionType>();
            }
        ...
        private void GetDetectionType(bool p1, int p2, Models.Detector detector, List<Models.DetectionType> detectionstypeslist)
        {
            if (p1)
            {
                Legacy.Common.Models.DetectionType dettype = (from r in detectionstypeslist
        ...
        private void SetApproaches()
        {
            ...
            foreach (Legacy.Common.Data.Signals.Graph_DetectorsRow row in DetectorsTable)
            {
                ...
                if (signal.Approaches == null)
                {
                    signal.Approaches = new List<Legacy.Common.Models.Approach>();
                }
        ...
        {
            Legacy.Common.Models.Approach newApproach = new Models.Approach();
        ...
        public void GetRecords()
        {
            ...
            Legacy.Common.Data.SignalsTableAdapters.SignalsTableAdapter sta = new Data.SignalsTableAdapters.SignalsTableAdapter();
            
            SignalsTable = sta.GetData();

            Legacy.Common.Data.SignalsTableAdapters.Graph_DetectorsTableAdapter gta = new Data.SignalsTableAdapters.Graph_DetectorsTableAdapter();
            DetectorsTable = gta.GetData();

            Legacy.Common.Data.SignalsTableAdapters.SPM_CommentTableAdapter cta = new Data.SignalsTableAdapters.SPM_CommentTableAdapter();
            CommentsTable = cta.GetAllData();

            Legacy.Common.Data.SignalsTableAdapters.ApproachRouteDetailTableAdapter rta = new Data.SignalsTableAdapters.ApproachRouteDetailTableAdapter();
            RouteDetailTable = rta.GetData();

            Legacy.Common.Data.SignalsTableAdapters.ApproachRouteTableAdapter arAdapter = new Data.SignalsTableAdapters.ApproachRouteTableAdapter();
            RouteTable = arAdapter.GetData();

            Legacy.Common.Data.ActionTableAdapters.ActionLog_DisabledTableAdapter alta = new Data.ActionTableAdapters.ActionLog_DisabledTableAdapter();

            ActionLogTable = alta.GetData();


            Legacy.Common.Data.ActionTableAdapters.Metric_ListTableAdapter mta = new Data.ActionTableAdapters.Metric_ListTableAdapter();
            MetricList = mta.GetData();

            Legacy.Common.Data.ActionTableAdapters.AgenciesTableAdapter ata = new Legacy.Common.Data.ActionTableAdapters.AgenciesTableAdapter();
            ActionAgencies = ata.GetData();

            Legacy.Common.Data.ActionTableAdapters.Action_Log_MetricsTableAdapter almt = new Data.ActionTableAdapters.Action_Log_MetricsTableAdapter();
            ActionLogMetrics = almt.GetData();

            Legacy.Common.Data.ActionTableAdapters.ActionsListTableAdapter actionsTA = new Data.ActionTableAdapters.ActionsListTableAdapter();
            ActionsList = actionsTA.GetData();

            Legacy.Common.Data.ActionTableAdapters.Action_Log_ActionsTableAdapter actionlogactionsta = new Data.ActionTableAdapters.Action_Log_ActionsTableAdapter();
            ActionLogActions = actionlogactionsta.GetData();

            Legacy.Common.Data.SettingsTableAdapters.MOE_UsersTableAdapter usersTA = new Legacy.Common.Data.SettingsTableAdapters.MOE_UsersTableAdapter();
        ...
        public void GetSignalsList()
        {
            ...
            foreach (Legacy.Common.Data.Signals.SignalsRow row in SignalsTable)
            {
        ...
        public void GetDetectorList()
        {
            ...
            foreach (Legacy.Common.Data.Signals.Graph_DetectorsRow row in DetectorsTable)
            {
                List<Legacy.Common.Models.DetectionType> detectionstypeslist = (from r in db.DetectionTypes
                                                                             select r).ToList();
                ...
                if (!row.IsNull("Phase") || row.Phase != "0" || row.Phase != "" || row.Det_Channel != 0)
                {
                    ...
                    if (d.DetectionTypes == null && d.DetectionTypeIDs == null)
                    {
                        ...
                        d.DetectionTypes = new List<Legacy.Common.Models.DetectionType>();
        ...
        public void ConvertApproachDetailDirections()
        {
            ...
            List<Legacy.Common.Models.ApproachRoute> ApproachRoutes = new List<Models.ApproachRoute>();
            foreach (var ApproachRouteRow in RouteTable)
            {
                Legacy.Common.Models.ApproachRoute approachRoute = new Models.ApproachRoute();
...

        {
            ...
            List<Legacy.Common.Models.ActionLog> Actions = new List<Models.ActionLog>();

            List<Legacy.Common.Models.Action> ActionTypes = (from r in db.Actions select r).ToList();

            List<Legacy.Common.Models.Agency> ActionAgencies = (from r in db.Agencies select r).ToList();

            List<Legacy.Common.Models.MetricType> MetricTypes = (from r in db.MetricTypes select r).ToList();

            List<Legacy.Common.Data.Action.ActionLog_DisabledRow> ActionLogList = ActionLogTable.ToList();
            List<Legacy.Common.Data.Action.Action_Log_ActionsRow> ActionLogActionsList = ActionLogActions.ToList();

            foreach (var row in ActionLogTable)
            {
                if (row.Name != "" || row.Comment != "")
                {
                    Legacy.Common.Models.ActionLog newAction = new Legacy.Common.Models.ActionLog();
                    ...
                    {
                        newAction.MetricTypes = new List<Legacy.Common.Models.MetricType>();
                    }
                    ...
                    {
                        newAction.Actions = new List<Legacy.Common.Models.Action>();
                    }
...
public class DetectorConverter
{
    ...
    [Required]
    public Legacy.Common.Models.Detector GraphDetectorModel { get; set; }
