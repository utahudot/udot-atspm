...
//            Legacy.Common.Business.PlanCollection plans, bool isThruMovement, bool showLaneVolumes, bool showTotalVolumes, 
//            int binSize)
//        {
...
//            string signalId, Legacy.Common.Business.PlanCollection plans, bool isThruMovement, 
...
//                foreach (Legacy.Common.Business.Detector detector in ThruDetectors)
//                {

//                    laneCount++;
//                    foreach (Legacy.Common.Business.Volume volume in detector.Volumes.Items)
//                    {
//                        if (showLaneVolumes)
//                        {
...
//                //SortedDictionary<DateTime, int> NBTotals = new SortedDictionary<DateTime, int>();
//                foreach (Legacy.Common.Business.Detector detector in RTDetectors)
//                {
...
//                //SortedDictionary<DateTime, int> NBTotals = new SortedDictionary<DateTime, int>();
//                foreach (Legacy.Common.Business.Detector detector in LTDetectors)
//                {
