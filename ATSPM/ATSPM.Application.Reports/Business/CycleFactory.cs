...
namespace ATSPM.Application.Reports.Business
{
    public static class CycleFactory
    {
        ...
        public static List<RedToRedCycle> GetRedToRedCycles(Approach approach, DateTime startTime, DateTime endTime, IControllerEventLogRepository cel)
        {
        ...
        private static EventType GetYellowToRedEventType(int EventCode)
        {
            switch (EventCode)
            {
                case 8:
