...
namespace ApplicationCoreTests.Analysis
{
    public class CreateRedToRedCyclesTests : IDisposable
    {
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "Timestamp Order")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "Filter Events")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "No Start Event")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "No End Event")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "No Green Event")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "No Yellow Event")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "Mismatched Signals")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "Mismatched Phases")]
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "Signal Grouping")]
        public async void CreateRedToRedCyclesSignalGroupingTest()
        {
            ...
            var actual = result.SelectMany(s => s.Select(s => s.SignalId));
        ...
        [Fact]
        [Trait(nameof(RedToRedCycle), "Phase Grouping")]
        public async void CreateRedToRedCyclesPhaseGroupingTest()
        {
            ...
            var actual = result.SelectMany(s => s.Select(s => s.Phase));
