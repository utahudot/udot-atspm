...
{
    /// <inheritdoc />
    public partial class _20231218170917_EFCore6Upgrade : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
<<<<<<<< HEAD:ATSPM/PostgreSQLDatabaseProvider/Migrations/Config/20240109162649_EFCore6Upgrade.cs
                    TimeStamp = table.Column<DateTime>(type: "timestamp", nullable: false),
========
                    TimeStamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
>>>>>>>> main:ATSPM/PostgreSQLDatabaseProvider/Migrations/Config/20231218194815_20231218170917_EFCore6Upgrade.cs
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceType = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false, defaultValue: "Unknown"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "character varying(512)", unicode: false, maxLength: 512, nullable: true),
<<<<<<<< HEAD:ATSPM/PostgreSQLDatabaseProvider/Migrations/Config/20240109162649_EFCore6Upgrade.cs
                    Date = table.Column<DateTime>(type: "timestamp", nullable: false, defaultValue: new DateTime(2024, 1, 9, 9, 26, 49, 733, DateTimeKind.Local).AddTicks(4822)),
========
                    Date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2023, 12, 18, 12, 48, 15, 240, DateTimeKind.Local).AddTicks(4980)),
>>>>>>>> main:ATSPM/PostgreSQLDatabaseProvider/Migrations/Config/20231218194815_20231218170917_EFCore6Upgrade.cs
...
>>>>>>>> main:ATSPM/PostgreSQLDatabaseProvider/Migrations/Config/20231218194815_20231218170917_EFCore6Upgrade.cs
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceStatus = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false, defaultValue: "Unknown"),
                    Notes = table.Column<string>(type: "character varying(512)", unicode: false, maxLength: 512, nullable: true),
                    LocationId = table.Column<int>(type: "integer", nullable: false),
