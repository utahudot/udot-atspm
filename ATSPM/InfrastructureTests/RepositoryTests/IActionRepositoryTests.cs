...
{
    public class IActionRepositoryTests : IDisposable
    {
        ...
        public IActionRepositoryTests(ITestOutputHelper output)
        {
            _output = output;
            ...
            var contextOptions = new DbContextOptionsBuilder<ConfigContext>()
            .UseInMemoryDatabase()
            .ConfigureWarnings(b => b.Ignore(InMemoryEventId.TransactionIgnoredWarning))
            .Options;


            _db = new ConfigContext(new DbContextOptionsBuilder<ConfigContext>().EnableSensitiveDataLogging().UseSqlite(_connection).Options);
