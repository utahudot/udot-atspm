...
namespace ATSPM.Infrasturcture.Data
{
    public partial class MOEContext : DbContext
    {
        ...
        //public virtual DbSet<Applicationz> Applications { get; set; }
        ...
        //public virtual DbSet<StagingControllerEventLog20190915> StagingControllerEventLog20190915s { get; set; }
...
//                optionsBuilder.UseSqlServer("Data Source = SRWTCDEVDB;Initial Catalog=MOE; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False");
//            }
//        }

        //dotnet user-secrets set ConnectionStrings:Development "Data Source = SRWTCDEVDB; Initial Catalog = MOE; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False"
        //dotnet user-secrets set ConnectionStrings:Staging "Data Source = SRWTCDEVDB; Initial Catalog = MOE; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False"
        //dotnet user-secrets set ConnectionStrings:Production "Data Source = SRWTCDEVDB; Initial Catalog = MOE; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False"
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Applicationz>(entity =>
            //{
            ...
            //    entity.HasOne(d => d.Applicationz)
