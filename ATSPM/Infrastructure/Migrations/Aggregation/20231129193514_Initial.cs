    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BinStartTime = table.Column<DateTime>(type: "timestamp", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApproachPcdAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PhaseNumber, x.IsProtectedPhase });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApproachSpeedAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.ApproachId });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApproachSplitFailAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.ApproachId, x.PhaseNumber, x.IsProtectedPhase });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApproachYellowRedActivationAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PhaseNumber, x.IsProtectedPhase });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhaseCycleAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PhaseNumber });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhaseLeftTurnGapAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PhaseNumber });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhaseSplitMonitorAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PhaseNumber });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhaseTerminationAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PhaseNumber });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreemptionAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PreemptNumber });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriorityAggregations", x => new { x.BinStartTime, x.SignalIdentifier, x.PriorityNumber });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignalEventCountAggregations", x => new { x.BinStartTime, x.SignalIdentifier });
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignalPlanAggregations", x => new { x.SignalIdentifier, x.Start, x.End });
                },
