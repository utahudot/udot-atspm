...
namespace ControllerLogger.Services
{
    public class Asc3Decoder
    {
        ...
        public static IEnumerable<ControllerEventLog> DecodeAsc3File(string fileName, string signalId, DateTime earliestAcceptableDate)
        {
            ...
            var memoryStream = FileToMemoryStream(fileName);
