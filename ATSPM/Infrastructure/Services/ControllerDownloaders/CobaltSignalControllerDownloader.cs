...
namespace ATSPM.Infrasturcture.Services.ControllerDownloaders
{
    ...
    {
        public CobaltSignalControllerDownloader(ISFTPDownloaderClient client, ILogger<CobaltSignalControllerDownloader> log, IOptionsSnapshot<SignalControllerDownloaderConfiguration> options) : base(client, log, options) { }
