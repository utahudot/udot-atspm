...
namespace MOE.Common.Business
{
    public class AdvancedSpeedDataExport
    {
        ...
        private ISignalsRepository _signalRepository;


        public AdvancedSpeedDataExport(string signalId, string location, DateTime startDate, DateTime endDate,
            int binSize, List<string> DayOfweek, ISignalsRepository signalRepository)
        {
            var signal = _signalRepository.GetLatestVersionOfSignalBySignalID(signalId);
